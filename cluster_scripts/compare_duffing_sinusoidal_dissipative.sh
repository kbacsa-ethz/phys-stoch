...
python gen_config.py -rp "$PWD" -type dissipative -ext sinusoidal -dynamics duffing -ndof 2 -noise 0.20 -n_iter 500 -l_x 0.000001 -l_y 0.000001 -u_x 0.000001 -u_y 0.000001
